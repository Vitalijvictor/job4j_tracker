 ...
 * Векторы в основном попадают в унаследованные классы, но теперь они полностью совместимы с коллекциями.
 *
 * Vector реализует динамический массив, что означает,
 * что он может увеличиваться или уменьшаться по мере необходимости.
 * Как и массив, он содержит компоненты, к которым можно получить доступ, используя целочисленный индекс
 * Они очень похожи на ArrayList,
 * но Vector синхронизирован и имеет какой-то устаревший метод, который не содержит каркас коллекции.
