...
2. Добавьте в этом классе 2 конструктора: явный конструктор по умолчанию, конструктор с тремя параметрами, который будет инициализировать поля переданными значениями;
